...
const AppHeader: React.FC = () => {
  ...
  // CTRL/CMD + K Focus Shortcut (optional, still works)
  useEffect(() => {
      ...
      <div className="flex w-full flex-col md:flex-row md:px-6">
        ...
        <div className="flex w-full items-center justify-between px-3 py-3 border-b border-gray-200 dark:border-gray-800 lg:border-b-0 lg:py-4 lg:px-0">
          ...
          <button
            ...
            className="w-10 h-10 lg:w-11 lg:h-11 flex items-center justify-center text-[#ae8643] rounded-lg border-gray-200 dark:border-gray-800 hover:bg-[#ae8643]/10"
          >
            {isMobileOpen ? (
              // Close Icon
              <svg
        ...
        <div className="hidden md:flex items-center justify-end w-full px-0 gap-4">
          <a
            ...
            className="text-blue-800 dark:text-[#ae8643]"
          >
            View Website
          </a>
          <UserDropdown />
...
//           <button
//             className="items-center justify-center w-10 h-10 text-[#ae8643] border-gray-200 rounded-lg z-9999 dark:border-gray-800 lg:flex dark:text-[#ae8643] lg:h-11 lg:w-11 lg:border hover:bg-[#ae8643]/10"
//             onClick={handleToggle}
//             aria-label="Toggle Sidebar"
//           >
//             {isMobileOpen ? (
