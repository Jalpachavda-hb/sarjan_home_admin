...
//     // For contact field: allow only numbers and max 10 digits
...
//       if (!clientData.name) newErrors.name = "Name is required for new client";
//       // if (!clientData.email)
//       //   newErrors.email = "Email is required for new client";
//       const contactError = validateContact(clientData.contact);
//       if (!clientData.contact)
//         newErrors.contact = "Contact is required for new client";
