...
//           Submit
//         </Button>
//         <Button className="canclebtn" onClick={()=> navigate(-1)}>Cancel</Button>
//       </div>
//     </div>
//   );
// };
...
const AddCategory: React.FC = () => {
  ...
  const handleSubmit = async () => {
    const values = { categoryName };
    const validationErrors: ValidationErrors = validateCategory(values);
  ...
  return (
    <div>
      ...
      <div className="flex space-x-4 mt-4">
        ...
        <Button className="canclebtn" onClick={() => navigate("/admin/projects_category")}>
          Cancel
        </Button>
      </div>
    </div>
