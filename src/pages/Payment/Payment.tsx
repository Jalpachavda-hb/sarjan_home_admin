  ...
  //     const matchesSite = siteFilter ? item.siteName === siteFilter : true;
  ...
  import TablePagination from "@mui/material/TablePagination";
  import { useState, useEffect } from "react";
  import { fetchSiteList ,getAdminId  } from "../../utils/Handlerfunctions/getdata";
  // import { fetchPaymentDetails } from "../../utils/Handlerfunctions/getPaymentData";
  ...
  export default function Payment() {
    ...
    //     const data = await fetchPaymentDetails("1"); // 👈 pass adminId dynamically
    //     setTableData(data);
    //   };
    //   loadPayments();
    // }, []);
  useEffect(() => {
  const loadPayments = async () => {
    const adminId = getAdminId();  // 👈 use your helper
    if (!adminId) return;
